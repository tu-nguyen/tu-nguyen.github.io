...
const Navbar = () => {
  ...
  return (
    <nav className='sticky top-0 bg-black-700 border-b border-black -mt-20 z-50'>
      <div className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8'>
        <div className='flex h-20 items-center justify-between'>
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            <a href='#' className='flex flex-shrink-0 items-center ml-3 mr-6'>
              <span className='text-white text-xl font-bold ml-2 uppercase'>Tu</span>
            </a>
            ...
            <div className='ml-auto'>
              <div className='flex space-x-5'>
                ...
                <a href='../Tu Nguyen Resume.pdf' target="_blank" className='text-white bg-sky-900 hover:bg-blue-700 hover:text-sky rounded-md mx-6 px-3 py-2 uppercase'>Resume</a>
              </div>
            </div>
          </div>
        </div>
