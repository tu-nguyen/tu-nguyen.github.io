...
const Projects = () => {
    ...
    return (
    <section id= 'projects' className='pt-12 sm:pt-24 md:pt-24 lg:pt-24 text-white'>
        <div className="min-h-screen xl:min-h-fit">
            <h2 className='text-white text-3xl pt-16 sm:pt-6 font-extrabold text-center sm:text-5xl xl:py-6'>
                Projects
            </h2>
