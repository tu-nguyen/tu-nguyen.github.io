  ...
  return (
    <section id='about' className='bg-black-700 px-4 pt-36'>
        ...
        <div className='static'>
            <div className='absolute h-screen content-center left-0 z-0'>
                <ul className="">
                    <li className='p-3'>
                        <a href="https://www.linkedin.com/in/tu-nguyen/" target="_blank" title="LinkedIn">
                            <svg viewBox="0 0 16 16" className="bg-black text-white fill-current h-8 inline-block">
                    ...
                    <li className='p-3'>
                        <a href="https://www.github.com/tu-nguyen" target="_blank" title="Github">
                            <svg viewBox="0 0 496 512" className="bg-black text-white fill-current h-8 inline-block">
                    ...
                    <li className='p-3'>
                        <a href="mailto:tu.t.nguyen93@gmail.com" title="Email">
                            <svg fill="#000000" viewBox="0 0 1920 1920" className="bg-black text-white fill-current h-8 inline-block">
                    ...
                    <li className='p-3'>
                        ...
                        <svg viewBox="0 0 24 24" className="bg-black text-white fill-current h-8 inline-block">
                    ...
                    <li className='p-3'>
                        <a href="./Tu Nguyen Resume.pdf" title="Resume">
                            <svg fill="#000000" viewBox="0 0 256 256" className="bg-black text-white fill-current h-8 inline-block">
                                <g>
