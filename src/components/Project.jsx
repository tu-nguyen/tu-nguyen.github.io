    ...
    if (demo) {
      return (
        <a href={project.demoLink} target="blank">
          <svg viewBox="0 0 64 64" className="h-6" stroke-width="3" stroke="#0369A1" fill="none">
      ...
      return (
        <>
          <svg viewBox="0 0 64 64" className="h-6" stroke-width="3" stroke="#FF0000" fill="none">
            <path d="M39.93,55.72A24.86,24.86,0,1,1,56.86,32.15a37.24,37.24,0,0,1-.73,6"/>
            <path d="M37.86,51.1A47,47,0,0,1,32,56.7"/>
            <path d="M32,7A34.14,34.14,0,0,1,43.57,30a34.07,34.07,0,0,1,.09,4.85"/>
            <path d="M32,7A34.09,34.09,0,0,0,20.31,32.46c0,16.2,7.28,21,11.66,24.24"/>
      ...
      />
        ...
        <div className={`py-6 w-74 shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl filter-item ${tech_filter}`}> 
          ...
          <div className="px-6">
            ...
            <div className="px-6">
              <h2 className='font-bold text-lg text-center' onClick={toggle}>
                {project.title}
              </h2>
              ...
              <div className="pt-3">
                ...
                <div className="float-right px-1">
                  <a href={project.githubLink} target="blank">
                    <svg viewBox="0 0 496 512" className="fill-current h-6">
