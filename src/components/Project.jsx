...
const Project = ({ project }) => {
  ...
  return (
    <>
      ...
      <div className={`w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl filter-item ${tech_filter}`} onClick={toggle}>
        
        <div className="px-4">
          
          <img className="h-48 w-72 object-cover rounded-t-xl" src={`${project.imageLink}`}/>
          
          <div className="px-4 py-3 h-58 w-72 grid grid-flow-row auto-rows-max">
            
            <h2 className='text-white pb-4 font-bold text-xl w-auto'>
              {project.title}
            </h2>
